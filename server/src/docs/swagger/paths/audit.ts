export const auditPaths = {
  "/audit/upload": {
    post: {
      ...
      description:
        "Upload a file or send data directly for security analysis and threat detection. Use the 'Try it out' button and select the desired content type from the dropdown.",
      tags: ["Audit"],
                ...
                fileUpload: {
                  ...
                  value: {
                    ...
                    summary: {
                      ...
                      flaggedValue: 0,
                      message:
                        "File uploaded successfully. 5 records queued for processing. Threats will be detected asynchronously.",
                    },
