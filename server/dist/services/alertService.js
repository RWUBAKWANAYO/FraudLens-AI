...
class AlertService {
    static findMany(companyId, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const where = queryBuilder_1.QueryBuilder.buildWhere({ companyId }, filters, ["title", "summary"], search);
            ...
            const orderBy = queryBuilder_1.QueryBuilder.buildSort(sortBy, sortOrder, {
                validSortFields: constants_1.VALID_ALERT_SORT_FIELDS,
                defaultSort: "createdAt",
            });
            const [data, _totalCount] = yield Promise.all([
                db_1.prisma.alert.findMany({
                    where,
                    include: constants_1.ALERT_INCLUDE,
                    orderBy,
            ...
            const paginationResult = yield queryBuilder_1.QueryBuilder.buildPaginationResult(db_1.prisma.alert, where, pagination.page, pagination.limit);
