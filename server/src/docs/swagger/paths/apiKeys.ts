export const apiKeyPaths = {
  "/api-keys": {
    ...
    get: {
      ...
      description:
        "Retrieve all API keys for the current user's company. Requires ADMIN or MANAGER role.",
      tags: ["API Keys"],
  ...
  "/api-keys/{id}": {
    ...
    get: {
      ...
      description:
        "Retrieve detailed information about a specific API key. Requires ADMIN or MANAGER role.",
      tags: ["API Keys"],
      security: [{ BearerAuth: [] }, { ApiKeyAuth: [] }],
      responses: {
        "200": {
  ...
  "/api-keys/{id}/rotate-secret": {
    ...
    patch: {
      ...
      description:
        "Rotate the secret for an API key (generates new secret). Requires ADMIN or MANAGER role.",
      tags: ["API Keys"],
      security: [{ BearerAuth: [] }, { ApiKeyAuth: [] }],
      responses: {
        "200": {
